...
{
    public const float DEFAULT_SHORTFALL_PENALTY_PER_HOUR = 45.0;
    /**
     * Class constructor.
     *
     * @param float $coverageThreshold
     * @param float $shortfallPenaltyPerHour
     * @param float $balanceWeight
     * @param float $initialTemperature
     * @param float $coolingRate
    ...
    /**
     * Return a copy of this config with shortfallPenaltyPerHour replaced, leaving
     * every other tunable intact. Lets a data-driven shortfall penalty, resolved
     * at generation time, override the static default.
     *
     * @param float $shortfallPenaltyPerHour
     * @return self
     */
    public function withShortfallPenaltyPerHour(float $shortfallPenaltyPerHour): self
    {
        return new self(
            coverageThreshold: $this->coverageThreshold,
